...
train_loader = data_utils.generate_data_loader(new_cleaned_lines, config_param['batch_size'], item_dict, MAX_SEQ_LENGTH, is_bseq=True, is_shuffle=True)
...
rec_sys_model = model.RecSysModel(config_param, MAX_SEQ_LENGTH, item_dict, reversed_item_dict, exec_device, data_type)
